package com.example.lesson2colormeviews
...
import com.example.lesson2colormeviews.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        val clickableViews: List<View> = listOf(binding.boxOneText, binding.boxTwoText, binding.boxThreeText, binding.boxThreeText,
